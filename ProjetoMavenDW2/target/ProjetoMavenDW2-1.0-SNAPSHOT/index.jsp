    ...
    <body>
        ...
        <div class="jumbotron" id="jumbo">
            <div class="container text-center">
                ...
                <p>Bem vindo! Aqui você pode submeter artigos de vários gêneros. Caso não esteja cadastrado
                    como autor, preencha o formulário abaixo.</p>
            </div>            
        </div>
                ...
                <div class="col-sm-6">
                    <form method="post" action="../AutorServlet" class="form-horizontal"> 
                        ...
                        <div>
                            <div class="form-group">
                                <div class="container">
                                    <a href="JSPs/artigo.jsp">Já está cadastrado? Submeta seu artigo</a>
                                </div>
                            </div>
                        </div>
